        ...
        window.onload = function () {
            const vm = new Vue({
                ...
                methods: {
                    ...
                    register(){
                        window.location = "User/registerPage.jsp"
                    }
                }
            })
            const vm2 = new Vue({
...
<div id="actions">
    <el-menu :default-active="activeIndex" active-text-color="#6497f8" class="el-menu-demo" background-color="#182840" text-color="#f3f8f4" mode="horizontal" @select="handleSelect">
        ...
        <el-submenu index="3">
            ...
            <el-menu-item index="3-1">驿站站点登录</el-menu-item>
...
<div id="center">
    ...
    <div id="loginArea">
        <div id="loginArea-methods">
            <p style="margin-left: 20px">用户登录</p>
            <hr>
        </div>
        <form action="user/userLogin" method="post">
            <el-input v-model="username" prefix-icon="iconfont icon-yonghu" placeholder="请输入账号" name="username" type="text" style="margin-bottom: 10px;margin-left: 20px;margin-right: 20px;width: 230px" clearable></el-input>
            ...
            <el-button id="registerBtn" style="margin-left: 15px" @click="register" round>没有账号?</el-button>
        </form>
        <div id="loginArea-moreActions">
            <span><a href="loginPageForAdmin.jsp" style="color: #a9aeaa;text-decoration: none">管理员登录</a></span>
            <span style="position: relative;float: right"><a href="User/findPassWord.jsp">忘记密码</a></span>
        </div>
    </div>
    <div id="loginRight">
    </div>
